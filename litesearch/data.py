...
# %% auto #0
__all__ = ['skip_folder_re', 'skip_file_re', 'code_exts', 'file_exts', 'PROFILES', 'needs_ocr', 'clean_md', 'ocr_parse',
           'oxide_parse', 'pdf_parse', 'SafeFastChunker', 'chunk_markdown', 'chunk_spans', 'repo_root', 'spec',
           'pyparse', 'ipynb_parse', 'non_py_sigs', 'chunk_texts', 'Profile', 'register_profile', 'profile_for',
