...
# %% auto #0
__all__ = ['skip_folder_re', 'skip_file_re', 'code_exts', 'file_exts', 'MIN_PARALLEL_FILES', 'needs_ocr', 'clean_md', 'ocr_parse',
           'oxide_parse', 'pdf_parse', 'SafeFastChunker', 'chunk_markdown', 'chunk_spans', 'repo_root', 'spec',
           'pyparse', 'ipynb_parse', 'non_py_sigs', 'chunk_texts', 'file_parse', 'pkg2files', 'dir2files', 'pkg2chunks',
