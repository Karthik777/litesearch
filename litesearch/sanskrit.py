...
# %% auto #0
__all__ = ['VEDIC_MARKS', 'DANDA', 'DDANDA', 'SANSKRIT_TOKENIZE', 'CITE_RE', 'strip_vedic', 'deva2ascii', 'detect_script',
           'fold_token', 'sanskrit_tokenizer', 'register_sanskrit', 'cite_parts']
