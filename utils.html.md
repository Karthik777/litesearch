...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L52"
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L70"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L88"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def FastEncode(
    model_dict:fastcore.basics.AttrDict={'model': 'onnx-community/embeddinggemma-300m-ONNX', 'onnx_path': 'onnx/model.onnx', 'prompt': {'document': 'title: none | text: {text}', 'query': 'task: search result | query: {text}'}}, # model dict with model repo, onnx path and prompt templates
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L200"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L195"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L208"
target="_blank" style="float:right; font-size:smaller">source</a>
...
*A stable name for whatever encoder wrote a store: the model repo, not
the object. ’’ when it cannot be named.*
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L219"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def FastEncodeImage(
    model_dict:fastcore.basics.AttrDict={'model': 'nomic-ai/nomic-embed-vision-v1.5', 'onnx_path': 'onnx/model.onnx', 'img_size': 224, 'mean': [0.485, 0.456, 0.406], 'std': [0.229, 0.224, 0.225]}, # model dict with model repo and onnx path
    normalize:bool=True, # normalize embeddings
    dtype:type=float16, # output dtype
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L288"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def FastEncodeMultimodal(
    model_dict:fastcore.basics.AttrDict={'model': 'onnx-community/siglip2-so400m-patch16-512-ONNX', 'vision_onnx': 'onnx/vision_model.onnx', 'text_onnx': 'onnx/text_model.onnx', 'img_size': 512, 'mean': [0.5, 0.5, 0.5], 'std': [0.5, 0.5, 0.5], 'max_seq_len': 64}, # model dict with vision_onnx and text_onnx paths
    normalize:bool=True, # normalize embeddings
    dtype:type=float16, # output dtype
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L330"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L320"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def encode_pdf_texts(
    ...
    **kw
)->fastcore.foundation.L: # forwarded to doc.pdf_chunks (min_len, st, end)
```
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/utils.py#L351"
target="_blank" style="float:right; font-size:smaller">source</a>
