...
``` python
def pdf_spans(
    doc:pdf_oxide.pdf_oxide.PdfDocument, st:int=0, end:NoneType=None
...
``` python
def pdf_markdown(
    doc:pdf_oxide.pdf_oxide.PdfDocument, st:int=0, end:NoneType=None, **kw
)->fastcore.foundation.L:
```
...
``` python
def pdf_images(
    doc:pdf_oxide.pdf_oxide.PdfDocument, st:int=0, end:NoneType=None, output_dir:NoneType=None
)->fastcore.foundation.L:
```
...
``` python
def SafeFastChunker(
    chunk_size:int=4096, delimiters:str='\n.?', pattern:Optional[str]=None, prefix:bool=False,
    consecutive:bool=False, forward_fallback:bool=False
):
```
...
``` python
def pdf_chunks(
    *, chunker:chonkie.chunker.base.BaseChunker=None
)->fastcore.foundation.L:
```
...
``` python
def pyparse(
    p:pathlib.Path=None, # path to a python file
...
``` python
def file_parse(
    p:pathlib.Path=None, # path to a code file
    *, code:str=None, # code string to parse
    imports:bool=False, # include import statements as code chunks
    assigns:bool=False, # include top-level assignments as code chunks
)->fastcore.foundation.L: # additional args to pass to pyparse
```
...
``` python
def Profile(
    name:str, exts:str='', parse:<built-in function callable>=None, chunker:<built-in function callable>=None,
    mode:str=None, detect:<built-in function callable>=None, kind:str=None, meta:<built-in function callable>=None
)->None:
```
...
```
    ...
    [{'content': 'function storeState(key, value) {...}', 'metadata': {'path': '/tmp/tmpg8cyvr9n.js', 'uploaded_at': 1789985444.1501038, 'lang': '.js'}}, {'content': 'function getState(key) {...}', 'metadata': {'path': '/tmp/tmpg8cyvr9n.js', 'uploaded_at': 1789985444.1501038, 'lang': '.js'}}, {'content': 'function removeState(key) {...}', 'metadata': {'path': '/tmp/tmpg8cyvr9n.js', 'uploaded_at': 1789985444.1501038, 'lang': '.js'}}, {'content': 'function setTheme(color,fn=null, ...args) {...}', 'metadata': {'path': '/tmp/tmpg8cyvr9n.js', 'uploaded_at': 1789985444.1501038, 'lang': '.js'}}]
...
)->fastcore.foundation.L: # additional args to pass to globtastic
```
...
def dir2chunks(
    ...
    *, skip_file_re:str='^[.]|^(?:setup\\.py|conftest\\.py)$', # regex to skip files
    ...
    types:str | list=None, # list or comma-separated str of ext types from: py, js, java, c, cpp, rb, r, ex, sh, web, doc, cfg
    exts:str | list=None, # list or comma-separated str of exts to include
)->fastcore.foundation.L: # additional args to pass to dir2files
```
...
def pkg2chunks(
    ...
    threadpool:bool=False, # threads rather than processes (see `_parse_files`)
    **kw
)->fastcore.foundation.L: # additional args to pass to pkg2files
```
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L400"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L390"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L380"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L374"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L366"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L438"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L426"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L416"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Karthik777/litesearch/blob/main/litesearch/data.py#L468"
target="_blank" style="float:right; font-size:smaller">source</a>
